    ...
    <header className="top-navbar sticky top-0 z-20 border-b border-white/45 bg-white/75 shadow-[0_4px_12px_rgba(15,23,42,0.055)] backdrop-blur-xl dark:border-white/10 dark:bg-[#071225]/95 dark:shadow-[0_4px_12px_rgba(0,0,0,0.13)]">
      <div className="top-navbar-inner flex flex-wrap items-center gap-3 px-3 py-3 lg:flex-nowrap lg:px-6">
        ...
        <button
          ...
          className="brand-pill apple-glass flex shrink-0 items-center gap-2 rounded-full px-2.5 py-2 transition-colors hover:bg-white/80 dark:border-white/15 dark:bg-slate-900/85 dark:text-white dark:hover:bg-slate-800/90"
          title={title}
        >
          <span className="glass-icon h-8 w-8 overflow-hidden rounded-full p-0.5">
            <img
          ...
          <span className="hidden text-sm font-bold text-light-ink-primary dark:text-dark-ink-primary sm:block">KL University</span>
        </button>
        ...
        <nav className="mobile-nav-row hide-scrollbar order-4 -mx-1 w-[calc(100%+0.5rem)] min-w-0 overflow-x-auto lg:order-none lg:mx-0 lg:w-auto lg:flex-1">
          ...
          <div className="nav-switch apple-glass flex w-max items-center gap-1 rounded-full border border-white/60 bg-white/60 p-1 backdrop-blur-2xl dark:border-white/20 dark:bg-slate-900/80">
            {topLinks.map((link) => {
              ...
              >
                ...
                <span className={cn('nav-icon-bubble', active && 'is-active')}>
                  <Icon size={15} className={cn('shrink-0 transition-colors duration-200', active && 'text-indigo-500 dark:text-indigo-100')} />
                </span>
        ...
        <div className="navbar-actions order-1 ml-auto flex shrink-0 items-center gap-2 lg:order-none lg:ml-0">
          ...
          <button
            ...
            title="Toggle theme"
            className="theme-pill apple-glass rounded-full p-2 text-light-ink-secondary transition-colors hover:bg-white/80 hover:text-light-ink-primary dark:border-white/15 dark:bg-slate-900/80 dark:text-slate-100 dark:hover:bg-slate-800/90 dark:hover:text-white"
          >
            {darkMode
