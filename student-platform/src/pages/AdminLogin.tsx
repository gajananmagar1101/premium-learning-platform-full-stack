...
import { GraduationCap, ShieldCheck, Mail, Lock, Eye, EyeOff, ArrowLeft, AlertCircle } from 'lucide-react'
    ...
    <div className="min-h-screen bg-light-base dark:bg-dark-base flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
        ...
        <Link to="/login" onClick={clearError}
          className="inline-flex items-center gap-1.5 text-sm text-light-ink-muted dark:text-dark-ink-muted hover:text-indigo-400 transition-colors mb-6 group">
